...
import { MenTShirtProduct } from '../ConstentData'
        ...
        <div className="pages-section">
          ...
          <div className="pages-page-container">
            ...
            <div className="product-sec">
              ...
              <ProductFetcher productData={MenTShirtProduct} selectedColor={selectedColor} selectedSize={selectedSize}  selectedPriceOrder={selectedPriceOrder}/>
            </div>
          </div>
        </div>
      </>
