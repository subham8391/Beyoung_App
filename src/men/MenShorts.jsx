...
import { MenShortsProduct } from '../ConstentData'
        ...
        <div className="pages-section">
          ...
          {windowWidth <= 760 ? null : (
            ...
            <div className="product-sec">
              <h2>MEN SHORTS</h2>
              <ProductFetcher productData={MenShortsProduct} selectedColor={selectedColor} selectedSize={selectedSize}  selectedPriceOrder={selectedPriceOrder}/>
            </div>
          </div>
        </div>
      </>
