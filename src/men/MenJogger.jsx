...
import { MenJoggerProduct } from '../ConstentData'
        ...
        <div className="pages-section">
          ...
          <div className="pages-page-container">
            ...
            <div className="product-sec">
              <h2>MEN JOGGER</h2>
              <ProductFetcher productData={MenJoggerProduct} selectedColor={selectedColor} selectedSize={selectedSize}  selectedPriceOrder={selectedPriceOrder}/>
            </div>
          </div>
        </div>
      </>
