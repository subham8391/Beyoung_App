...
import { MenTrouserProduct } from '../ConstentData'
        ...
        <div className="pages-section">
          ...
          <div className="pages-page-container">
            ...
            <div className="product-sec">
              <h2>MEN TROUSER</h2>
              <ProductFetcher productData={MenTrouserProduct} selectedColor={selectedColor} selectedSize={selectedSize}  selectedPriceOrder={selectedPriceOrder}/>
            </div>
          </div>
        </div>
      </>
