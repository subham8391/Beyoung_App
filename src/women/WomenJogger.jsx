...
import { WomenJoggerProduct } from '../ConstentData'
        ...
        <div className="pages-section">
          ...
          <div className="pages-page-container">
            ...
            <div className="product-sec">
              <h2>WOMEN JOGGER</h2>
              <ProductFetcher productData={WomenJoggerProduct} selectedColor={selectedColor} selectedSize={selectedSize}  selectedPriceOrder={selectedPriceOrder}/>
            </div>
          </div>
        </div>
      </>
