...
import { WomenTShirtProduct } from '../ConstentData'
        ...
        <div className="pages-section">
          ...
          {windowWidth <= 760 ? null : (
            ...
            <div className="product-sec">
              ...
              <ProductFetcher productData={WomenTShirtProduct} selectedColor={selectedColor} selectedSize={selectedSize}  selectedPriceOrder={selectedPriceOrder}/>
            </div>
          </div>
        </div>
      </>
