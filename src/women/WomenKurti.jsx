...
import { WomenKurtiProduct } from '../ConstentData'
        ...
        <div className="pages-section">
          ...
          <div className="pages-page-container">
            ...
            <div className="product-sec">
              <h2>WOMEN KURTI</h2>
              <ProductFetcher productData={WomenKurtiProduct} selectedColor={selectedColor} selectedSize={selectedSize}  selectedPriceOrder={selectedPriceOrder}/>
            </div>
          </div>
        </div>
      </>
